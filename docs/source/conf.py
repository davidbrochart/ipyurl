...
# -*- coding: utf-8 -*-
#
# ipyurl documentation build configuration file
#
...
_version_py = os.path.join(repo, 'ipyurl', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'ipyurl.tex', 'ipyurl Documentation',
